...
if __name__ == '__main__':
	...
	# out degree of faces 242 to 246 should be <= 1 or >= 2
	...
	#pi0 = 4
	# out degree of faces 175, 176, 147, 148, 149, 150, 121, 122, 123 should be <= 2 or >= 3
	pi = [1 if variable in ("z279,174", "z238,146", "z219,119", "z195,120", "z177,93", "z198,124", "z221,152", "z240,151", "z263,178", "z281,177", "z305,204") else 0 for variable in variableNames]
	pi0 = 2
	d = 0
